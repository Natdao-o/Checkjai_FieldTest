...
const url = import.meta.env.VITE_SUPABASE_URL || import.meta.env.SUPABASE_URL || defaultUrl
const anonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || import.meta.env.SUPABASE_ANON_KEY || defaultAnonKey
const serviceRoleKey = import.meta.env.VITE_SUPABASE_SERVICE_ROLE_KEY || import.meta.env.SUPABASE_SERVICE_ROLE_KEY || defaultServiceRoleKey
